           ...
           $.ajax({
               ...
               success: function (result) {
                   ...
                   for (i = 0; i < result.content.length; i++) {
                       ...
                       s += '<a class="linkProductShop" href="">'
                       ...
                       s += '<div class="c" style="display: inline">'
                       s += ' <p style="float: left; font-size: 0.9rem; padding-left: 33%" class="card-text products-price">$&nbsp;</p>'
                       s += ' <p style="float: left; class="card-text products-price-shop">' + result.content[i].productPrice + '</p>'
                       s += '</div>'
                       s += '<div>'
                       s += '<a class="a" th:href="@{\'/cart/buy/\' + ${product.id}}">'
            ...
            $.ajax({
                ...
                success : function(result){
                    ...
                    for (i=0;i<result.content.length;i++) {
                        s += '<div class="col-3 column-shop">'
                        s += ' <div class="card shop-cards box">'
                        s += '<a class="linkProductShop" href="/product?productName='+result.content[i].productName+'" >'
                        s += ' <img class="shop-img-top"  alt="" src='+ result.content[i].productImg+'>'
                        s += '</a>'
                        s += '<hr class="hr-card">'
                        s += '<div class="card-body">'
                        s += '<h5 class="card-title  products-name-shop" >' + result.content[i].productName + '</h5>'
                        s += '<div class="c" style="display: inline">'
                        s += ' <p style="float: left; font-size: 0.9rem; padding-left: 35%" class="card-text products-price">$&nbsp</p>'
                        s += ' <p style="float: left;" class="card-text products-price-shop">' + result.content[i].productPrice + '</p>'
                        s += '</div>'
                        s += '<div>'
                        s += '<a class="a" th:href="@{\'/cart/buy/\' + ${product.id}}">'
